...
var credentials = {
	...
	callbackURL: production ? 'http://sydjs.com/authentication/twitter?callback' : 'http://local.host:3000/authentication/twitter?callback'
};
...
exports.authenticateUser = function(req, res, next, callback)
{
	...
	var createSydjsUser = function() {
		...
		// Define data
		var splitName = data.twitterUser.profile.displayName.split(' '),
