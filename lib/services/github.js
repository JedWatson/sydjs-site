...
var credentials = {
	...
	callbackURL: production ? 'http://sydjs.com/authentication/github?callback' : 'http://local.host:3000/authentication/github?callback'
};
...
exports.authenticateUser = function(req, res, next, callback)
{
	...
	var createSydjsUser = function() {
		...
		// Define data
		var splitName = data.githubUser.profile.displayName.split(' '),
		...
		var userData = {
			...
			email: null, // GitHub API does not return email
